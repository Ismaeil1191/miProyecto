<?php 
	...
	if(isset($_POST["submit"])){
		...
		header("location:baño.php");
	}
	
	$data=[];
	$sql="select * from baño where PID={$_GET["id"]}";
	$res=$con->query($sql);
	if($res->num_rows>0){
        ...
        <div class='container mt-5'>
			<div class='row'>
				<div class='col-md-9 mx-auto'>
					<h2 class='text-muted mb-4'>Detalles del producto</h2><hr>
					<div class='row mt-5'>
						<div class='col-md-4'>
						...
						<div class='col-md-8'>
							...
							<p class="font-weight-bold">Precio <?php echo $data["PRICE"]; ?> €</p>
